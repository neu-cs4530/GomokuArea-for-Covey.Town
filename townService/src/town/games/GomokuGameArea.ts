...
/**
 * A GomokuGameArea is a GameArea that hosts a GomokuGame.
 * @see GomokuGame
 * @see GameArea
 */
export default class GomokuArea extends GameArea<GomokuGame> {
  protected getType(): InteractableType {
    return 'GomokuArea';
  }

  private _stateUpdated(updatedState: GameInstance<GomokuGameState>) {
